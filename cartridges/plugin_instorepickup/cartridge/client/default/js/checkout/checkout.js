...
var baseCheckout = require("jsfarmacias/checkout/checkout");
var baseSummaryHelpers = require("jsfarmacias/checkout/summary");
...
baseCheckout.updateCheckoutView = function () {
    $("body").on("checkout:updateCheckoutView", function (e, data) {
        ...
        baseSummaryHelpers.updateTotals(data.order.totals, data.order.shipping);
