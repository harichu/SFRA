...
function categoryToObject(category) {
    ...
    var result = {
        ...
        id: category.ID,
        promoAssetID: !empty(category.custom.promotionalAsset) ? category.custom.promotionalAsset : null,
        iconURL: category.custom.navigationIcon && !empty(category.custom.navigationIcon.getURL()) ? category.custom.navigationIcon.getURL() : null
    };
