...
module.exports = function productLineItem(product, apiProduct, options) {
    var productItem = base.call(this, product, apiProduct, options);
    productDecorators.promotions(product, options.promotions);
    productDecorators.custom(productItem, apiProduct);
    productDecorators.prescription(productItem, options.lineItem);
    return productItem;
};
