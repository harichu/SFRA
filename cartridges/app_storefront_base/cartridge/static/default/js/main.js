...
function validateBasket(data) {
  if (data.valid.error) {
    if (data.valid.message) {
      /**@todo ACF3 To update and use a new alert file */
...
function getModalHtmlElement() {
  ...
  var htmlString = "<!-- Modal -->" + "<div class=\"modal fade\" id=\"editProductModal\" tabindex=\"-1\" role=\"dialog\">" + "<span class=\"enter-message sr-only\"></span>" + "<!-- Modal content-->" + "<div class=\"modal-content\">" + "<div class=\"modal-header\">" + "    <button type=\"button\" class=\"close pull-right\" data-dismiss=\"modal\">" + "        <span aria-hidden=\"true\">&times;</span>" + "        <span class=\"sr-only\"> </span>" + "    </button>" + "</div>" + "<div class=\"modal-body\"></div>" + "<div class=\"modal-footer\"></div>" + "</div>" + "</div>" + "</div>";
...
function showConsentModal() {
  ...
  $.ajax({
    ...
    success: function success(response) {
      ...
      var htmlString = "\n            <div class=\"modal show fade\" id=\"consentTracking\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"".concat(textHeader, "\" aria-hidden=\"true\" style=\"display: block;\">\n                <div class=\"modal-dialog modal-dialog-centered\" role=\"document\">\n                    <div class=\"modal-content\">\n                        <div class=\"modal-header\">\n                            <h5 class=\"modal-title\">").concat(textHeader, "</h5>\n                        </div>\n                        <div class=\"modal-body\"></div>\n                        <div class=\"modal-footer\">\n                            <div class=\"button-wrapper\">\n                                <button type=\"button\" class=\"btn btn-secondary decline\" data-url=\"").concat(urlReject, "\">").concat(textNo, "</button>\n                                <button type=\"button\" class=\"btn btn-primary affirm\" data-url=\"").concat(urlAccept, "\">").concat(textYes, "</button>\n                            </div>\n                        </div>\n                    </div>\n                </div>\n            </div>\n            <div class=\"modal-backdrop fade show\"></div>");
      $("body").append(htmlString);
...
function addSpinner($target) {
  var $veil = $("<div class=\"veil\"><div class=\"underlay\"></div></div>"); // Default SFRA loading icon replaced
  //$veil.append('<div class="spinner"><div class="dot1"></div><div class="dot2"></div></div>');

  $veil.append("<div class=\"spinner\"><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div></div>");
      ...
      $.ajax({
        ...
        success: function success(data) {
          ...
          if (data.error) {
            ...
            /**
             * @todo ACF3 Refactor alerts to be unified into one single helper
             */
            "<div class=\"alert alert-success add-to-basket-alert text-center\"" + " role=\"alert\">" + data.msgSuccess + "</div>");
            setTimeout(function () {
              $(".add-to-basket-alert").remove();
