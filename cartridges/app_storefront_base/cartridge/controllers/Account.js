...
function getModel(req) {
    ...
    if (order) {
        ...
        /**
         * This session variable will prevent orders already completed from being recalculated,
         * and it's values from being updated when getting the Account model.
         *
         * The base cartridge Account-Show function, calls the getModel inside the base cartridge,
         * so this session variable cannot be placed anywhere else, without having to replace the
         * functions from it, and adding it to a different cartridge like app_storefront_core
        */
        session.custom.isAccountModel = true;
    ...
    session.custom.isAccountModel = false;
