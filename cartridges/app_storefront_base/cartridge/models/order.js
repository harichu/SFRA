...
function OrderModel(lineItemContainer, options) {
    ...
    if (!lineItemContainer) {
        ...
        this.orderNumber = Object.hasOwnProperty.call(lineItemContainer, "orderNo") ? lineItemContainer.orderNo : null;
        this.priceTotal  = totalsModel ? totalsModel.grandTotal : null; //NOSONAR
        this.creationDate = Object.hasOwnProperty.call(lineItemContainer, "creationDate") ? lineItemContainer.creationDate : null;
        this.orderEmail  = lineItemContainer.customerEmail;
        this.orderStatus = Object.hasOwnProperty.call(lineItemContainer, "status") ? lineItemContainer.status : null;
        this.productQuantityTotal = lineItemContainer.productQuantityTotal ? lineItemContainer.productQuantityTotal : null;

        if (modelConfig.numberOfLineItems === "*") {
            this.totals = totalsModel;
            this.lineItemTotal = productLineItemsModel ? productLineItemsModel.length : null; //NOSONAR
